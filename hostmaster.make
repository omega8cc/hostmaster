...
projects[openidadmin][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/openidadmin.tar.gz"
...
projects[ctools][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/ctools.tar.gz"

projects[features_extra][type] = "module"
;projects[features_extra][version] = "1.x-dev"
projects[features_extra][download][type] = "get"
projects[features_extra][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/features_extra.tar.gz"

projects[features][type] = "module"
;projects[features][version] = "1.2"
projects[features][download][type] = "get"
projects[features][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/features.tar.gz"
...
projects[hosting_task_gc][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/hosting_task_gc.tar.gz"
...
projects[protect_critical_users][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/protect_critical_users.tar.gz"
...
projects[revision_deletion][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/revision_deletion.tar.gz"

projects[strongarm][type] = "module"
;projects[strongarm][version] = "2.2"
projects[strongarm][download][type] = "get"
projects[strongarm][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/strongarm.tar.gz"

projects[userprotect][type] = "module"
;projects[userprotect][version] = "1.5"
projects[userprotect][download][type] = "get"
projects[userprotect][download][url] = "http://files.aegir.cc/dev/BOA-2.2.0/static/userprotect.tar.gz"
